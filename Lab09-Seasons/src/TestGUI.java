/**
 * TestGUI by Dagar Ahmed & Kris McCoy   v2.03
 */
import java.awt.*;
...
public class TestGUI 
{
    ...
    private static ArrayList<TestData> testResults = new ArrayList<TestData>();
        ...
        SwingUtilities.invokeLater(new Runnable() 
            {
                ...
                public void run() {
                    try {
                        testResults = new ArrayList<TestData>();
                        compileAllSrcFiles();  
    ...
    static class TestData {
        ...
        public static void header(String name) { 
            testResults.add(new TestData(name, true));
        }
        ...
        public static void srcButton(String srcFileName) { 
            ...
            testResults.add(new TestData(fileNames));
        }

        public static void srcButton(String[] srcFileNames) { 
            testResults.add(new TestData(srcFileNames));
        }

        private static void messageAlert(String m) {
            TestData newEntry = new TestData(m, false); //set message
            newEntry.setResultColorForMessage(false);  //red 
            testResults.add(0, newEntry);
        }

        public static void message(String m) {
            testResults.add(new TestData(m, false));
        }       
        ...
        public static Object testMethod(String cName, String name, Object[] args, String expOut, String userInputScript) {              
            ...
            try {                
                ...
                testResults.add(new TestData(cName+"."+name+"()",
